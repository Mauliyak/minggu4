...
st.title("ℌ𝔲𝔫𝔤𝔞𝔯𝔦𝔞𝔫 ℌ𝔢𝔞𝔯𝔱 𝔇𝔦𝔰𝔢𝔞𝔰𝔢")
st.write(f"**_Model's Accuracy_** :  :blue[**{accuracy}**]% (:violet[_Do not copy outright_])")
st.write("")
...
with tab1:
  ...
  st.sidebar.write(f":orange[Min] value: :orange[**{df_final['age'].min()}**], :violet[Max] value: :violet[**{df_final['age'].max()}**]")
  st.sidebar.write("")
  ...
  st.sidebar.write(f":orange[Min] value: :orange[**{df_final['trestbps'].min()}**], :violet[Max] value: :violet[**{df_final['trestbps'].max()}**]")
  st.sidebar.write("")
  ...
  st.sidebar.write(f":orange[Min] value: :orange[**{df_final['chol'].min()}**], :violet[Max] value: :violet[**{df_final['chol'].max()}**]")
  st.sidebar.write("")
  ...
  st.sidebar.write(f":orange[Min] value: :orange[**{df_final['thalach'].min()}**], :violet[Max] value: :violet[**{df_final['thalach'].max()}**]")
  st.sidebar.write("")
  ...
  st.sidebar.write(f":orange[Min] value: :orange[**{df_final['oldpeak'].min()}**], :violet[Max] value: :violet[**{df_final['oldpeak'].max()}**]")
  st.sidebar.write("")
